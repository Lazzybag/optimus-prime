...
        """
        print("🔍 Fetching all protocol adapters from /projects directory...")
        
        try:
...
    
    def save_results(self, filename="liquid_staking_adapters.json"):
...
    if rate_limit:
        print(f"📊 Rate Limit: {rate_limit['remaining']}/{rate_limit['limit']} requests")
    
